<template>
  <div class="tool-cog-wrapper">
    <div class="triad-status">
      <div v-for="agent in triad" :key="agent.id" 
           class="agent-cog-container" 
           :class="[agent.status, { active: agent.working }]">
        <div class="cog-icon" :title="agent.name">
...
const triad = ref([
  { id: 'a0', name: 'Supervisor', shortName: 'A0', status: 'idle', working: false },
  { id: 'a1', name: 'Architect', shortName: 'A1', status: 'idle', working: false },
  { id: 'a2', name: 'Executor', shortName: 'A2', status: 'idle', working: false }
])
</script>
